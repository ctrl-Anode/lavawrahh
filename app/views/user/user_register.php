...
<body>
    <?php
    include APP_DIR.'views/templates/user_nav_auth.php';
    ?>
    <main class="py-4">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <?php flash_alert(); ?>
                            <form id="regForm" method="POST" action="<?=site_url('user/user_register');?>">
                            <?php csrf_field(); ?>
                            <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="username" type="text" class="form-control " placeholder="Enter your Username" name="uname" required>
                                    </div>
                                </div>
                                <div class="row mb-3">
