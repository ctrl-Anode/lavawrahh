...
<head>
    ...
    <title>Edit Membership - Gym Management System</title>
    ...
    <div class="main-content">
        <div class="container">
            ...
            <div class="form-container">
                <form action="<?= site_url('auth/memberships/update/'. $membership['id']); ?>" method="POST">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="info" name="info" rows="3"><?= $membership['info']; ?></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="duration_months" class="form-label">Duration (in months):</label>
                        <input type="number" class="form-control" id="duration_months" name="duration_months" value="<?= $membership['duration_months']; ?>" required>
                    </div>
                    <div class="mb-3">
