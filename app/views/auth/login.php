            ...
            <div class="max-w-md mx-auto py-6 sm:px-6 lg:px-8">
                <div class="bg-black bg-opacity-80 rounded-lg overflow-hidden shadow-2xl">
                    <div class="px-6 py-4 bg-yellow-600 border-b border-yellow-700">
                        <h2 class="text-2xl font-oswald font-bold text-white">LOGIN TO YOUR ACCOUNT</h2>
                    </div>
                    <div class="p-6">
                        <?php flash_alert(); ?>
                        <form id="logForm" method="POST" action="<?=site_url('auth/login');?>">
                            ...
                            <div class="mb-6">
                                ...
                                <div>
                                    <input id="password" type="password" class="appearance-none border rounded w-full py-3 px-4 text-gray-200 bg-gray-800 mb-3 leading-tight focus:outline-none focus:ring-2 focus:ring-yellow-500 transition duration-300" name="password" minlength="8" required autocomplete="current-password">
                                </div>
                            </div>
                            <div class="flex items-center justify-between">
                                ...
                                <a class="inline-block align-baseline font-bold text-sm text-yellow-500 hover:text-yellow-400 transition duration-300" href="<?=site_url('auth/password-reset');?>">
